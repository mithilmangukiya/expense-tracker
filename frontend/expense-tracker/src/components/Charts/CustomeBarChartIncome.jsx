...
const CustomeBarChartIncome = ({data}) => {
             ...
             return (
                 <div className='bg-white shadow-md rounded-lg p-2 border border-gray-300'>
                     ...
                     <p className='text-sm text-gray-600'>
                         Amount: <span className='tetx-sm font-medium text-gray-900'>{currencySymbol}{payload[0].payload.amount}</span>
                     </p>
                 </div>
             )
         }
...
export default CustomeBarChartIncome